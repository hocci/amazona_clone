...
import { addToCart,removeFromCart } from '../actions/cartAcion'
            ...
            <div className="col-1">
                <div className="card card-body">
                    <ul>
                        <li>
                            <h2>
                                Subtotal ({cartItems.reduce((total, item)=> total + item.qty, 0)} items) : ${cartItems.reduce((total, item)=> total + item.qty * item.price, 0)}
                            </h2>
                        </li>
                        <li>
